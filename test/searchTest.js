...
var searchString;
var actualTags;
var expectedTags = '#help#calculus#math#random';
var expectedSingleTag = '#helpcalculusmathrandom';
var pidListSingle = [
  '-KfI8LzfiSnFjRWCgJt7',
  '-KfI8NEFcuvq1AnPfCUU',
  '-KfI8Pw0WZxUfk3jnyBJ',
...
describe('Post Search Test', function() {
  ...
  it('Given a user when searching for a single tag then posts containing that tag are returned', function(
    done
  ) {
    this.timeout(6000);
    // givenauser();
  ...
  it('Given a user when searching for multiple tags then posts containing those tags are returned', function(
    done
  ) {
    this.timeout(6000);
    // givenauser();
...
describe('Search Parser Test', function() {
  // Undefined search
  it('Given undefined search info when parsing the search string then a null value should be returned', function(
    done
  ) {
  ...
  // Null search
  it('Given null search info when parsing the search string then a null value should be returned', function(
    done
  ) {
    givenNullSearch();
    whenParsingSearch();
  ...
  // Expected Input
  it('Given expected search info when parsing the search string then a correct tag string is created', function(
    done
  ) {
  ...
  // Special Characters
  it('Given search info containing special characters when parsing the search string then a null value should be returned', function(
    done
  ) {
  ...
  it('Given a search string containing only whitespaces when parsing the search string then a null value should be returned', function(
    done
  ) {
  ...
  // Only # search
  it('Given search info containing only # when parsing the search string then a null value should be returned', function(
    done
  ) {
    givenOnlyHashtags();
    whenParsingSearch();
  ...
  it('Given search info containing #s at the end of the string when parsing the search string then a correct tag string is created', function(
    done
  ) {
  ...
  it('Given search info containing no spaces between the words of the string when parsing the search string then a correct tag string is created containing only 1 tag', function(
    done
  ) {
  ...
  it('Given search info containing one # at the beginning of the string when parsing the search string then a correct tag string is created', function(
    done
  ) {
...
function givenExpectedSearchInfo() {
  searchString = 'help calculus math random';
}
...
function givenNoSpacesBetweenWords() {
  searchString = '  helpcalculusmathrandom ';
}
