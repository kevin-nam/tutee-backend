    ...
    if (error) {
      ...
      firebase.database().ref(exports.CONNECTION_REFERENCE + uid2).transaction(function(data) {
        ...
        if (error) {
          ...
          notificationService.sendNotification(uid1, uid2, 'ACCEPTED_CONNECTION_REQUEST', null, function() {});
          notificationService.sendNotification(uid2, uid1, 'ACCEPTED_CONNECTION_REQUEST', null, function() {});
    ...
    if (error) {
      ...
      firebase.database().ref(exports.CONNECTION_REFERENCE + uid2).transaction(function(data) {
        ...
        if (error) {
          ...
          notificationService.sendNotification(uid2, uid1, 'NEW_CONNECTION_REQUEST', null, function() {});
